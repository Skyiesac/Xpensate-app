...
class RegisterSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        EmailOTP.objects.create(email=attrs["email"], otp=otpto)
        return attrs
...
class VerifyOTPSerializer(serializers.Serializer):
    ...
    def create_us(self, data):
        ...
        return {"message": "User created successfully", "tokens": user.get_tokens()}
...
class ForgetPassSerializer(serializers.Serializer):
    ...
    def validate(self, data):
        ...
        EmailOTP.objects.update_or_create(email=data["email"], defaults={"otp": otpto})
        return data
...
class ResetPassSerializer(serializers.Serializer):
    ...
    def validate(self, attrs):
        ...
        try:
            ...
            raise serializers.ValidationError(
                {"error": "This OTP is either unverified or invalid"}
            )
