...
class Group(models.Model):
    ...
    groupowner = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="admin", to_field="email"
    )
...
class Bill(models.Model):
    billowner = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="owned_bills", to_field="email"
    )
    bill_participants = models.ManyToManyField(
        User, through="BillParticipant", related_name="participated_in_bills"
    )
    group = models.ForeignKey(Group, on_delete=models.CASCADE)
